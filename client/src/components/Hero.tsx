...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[600px] lg:h-[700px] w-full overflow-hidden bg-background group">
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
        <div className="max-w-3xl space-y-8 animate-fade-in-up">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-background/10 border border-border text-foreground backdrop-blur-sm text-sm font-medium">
          ...
          <h1 className="text-4xl lg:text-6xl font-extrabold tracking-tight text-foreground leading-[1.15] drop-shadow-sm">
            Organize{" "}
            <span className="text-primary">Scientific Conferences</span> with
            Confidence
          </h1>

          <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl drop-shadow-sm">
            We provide a unified ecosystem designed to handle the complexities
            of modern conference management. Our platform was built to simplify
            the administrative burden of academic organizers.
          </p>
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-background/20 text-foreground hover:bg-background/40 backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100 translate-x-[-10px] group-hover:translate-x-0 hidden md:block"
      >
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-background/20 text-foreground hover:bg-background/40 backdrop-blur-sm transition-all opacity-0 group-hover:opacity-100 translate-x-[10px] group-hover:translate-x-0 hidden md:block"
      >
