                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <input
                          ...
                          className={`w-full border rounded-xl pl-9 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-ring bg-background text-foreground ${
                            confScope === "specific" &&
                            selectedConfIds.length === 0
