...
const AssignSessionsPage: React.FC = () => {
  ...
  const availableChairNameMap = React.useMemo(() => {
    return new Map(
      availableChairs.map((chair) => [chair.user_id, chair.full_name]),
    );
  }, [availableChairs]);
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <ChairCandidateSearch
                        sessionTempId={session.temp_id}
                        selectedChairId={session.chair_person_id}
                        selectedChairName={
                          session.chair_person_id
                            ? availableChairNameMap.get(session.chair_person_id)
                            : undefined
                        }
