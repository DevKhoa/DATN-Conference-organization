      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
        <div className="max-w-3xl space-y-8 animate-fade-in-up">
          ...
          <h1 className="text-4xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.15] drop-shadow-sm">
            Organize{" "}
            <span className="text-brand-300">Scientific Conferences</span> with
            Confidence
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Button
              ...
              icon={ArrowRight}
              iconPosition="right"
              className="bg-brand-600 hover:bg-brand-500 border-transparent shadow-lg shadow-brand-900/20"
