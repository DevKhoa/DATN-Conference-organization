    ...
    items: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YXNzaWdubWVudHxlbnwwfHwwfHx8MA%3D%3D' // Ảnh Dashboard/Laptop
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1768811838777-0507859b5ab9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHJldmlldyUyMHBhcGVyfGVufDB8fDB8fHww' // Ảnh Teamwork/Review
      },
      {
    ...
    items: [
      {
        ...
        image: 'https://media.istockphoto.com/id/1477483635/vi/anh/ng%C6%B0%E1%BB%9Di-%C4%91%C3%A0n-%C3%B4ng-tr%C6%B0%E1%BB%9Fng-th%C3%A0nh-thanh-to%C3%A1n-b%E1%BA%B1ng-th%E1%BA%BB-t%C3%ADn-d%E1%BB%A5ng-t%E1%BA%A1i-qu%C3%A1n-c%C3%A0-ph%C3%AA-c%E1%BA%ADn-c%E1%BA%A3nh-b%C3%A0n-tay-v%E1%BB%9Bi.jpg?s=612x612&w=0&k=20&c=WkwbyVV2RhYMhlIsUzYm4mgiBJGlaV_PMFqh7ekDR-A=' // Ảnh Payment/Card
      },
      {
        title: 'Check-in & Badging',
        desc: 'QR-code based rapid check-in and on-demand badge printing to eliminate queue bottlenecks.',
        image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=800&q=80' // Ảnh Event/Hội nghị
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1618044733300-9472054094ee?auto=format&fit=crop&w=800&q=80' // Ảnh Documents/Library
      }
    ]
  },
  {
...
const Features: React.FC = () => {
  ...
  const prevSlide = () => {
    setCurrentIndex((prev) => (prev - 1 + featureCategories.length) % featureCategories.length);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden rounded-3xl bg-slate-50/50 border border-slate-100">
            ...
            >
              {featureCategories.map((category) => (
                <div key={category.id} className="w-full flex-shrink-0 p-6 md:p-12">
          ...
          <div className="md:hidden flex justify-center gap-4 mt-6">
             <button onClick={prevSlide} className="p-2 rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm">
                <ChevronLeft className="w-5 h-5" />
             </button>
             <button onClick={nextSlide} className="p-2 rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm">
